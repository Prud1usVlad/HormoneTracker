...
builder.Services.AddDbContext<HormoneTrackerDBContext>(options =>
    options.UseLazyLoadingProxies().UseSqlServer("Data Source=PRUDIUSVLADPC\\DEV;Initial Catalog=HormoneTrackerDB;Integrated Security=True"));

builder.Services.AddScoped<IChartDataService, BasicChartDataService>();
builder.Services.AddScoped<IRecomendationService, BasicRecomendationsService>();
